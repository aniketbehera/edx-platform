...
class CourseFields(object):
    ...
    checklists = List(scope=Scope.settings,
        default=[
            {"short_description" : "Getting Started With Sokratik",
            ...
            {"short_description" : "Explore Sokratik's Support Tools",
             "items" : [{"short_description": "Explore the Help Forum",
                          "long_description": "Access the Help forum from the menu that appears when you click your user name in the top right corner of Studio.",
                          "is_checked": False,
                         ...
                         {"short_description": "Enroll in edX 101",
                          ...
                          "long_description": "Download the searchable reference documentation in PDF form.",
                          "is_checked": False,
            ...
            {"short_description" : "Draft Your Course About Page",
             "items" : [{"short_description": "Draft a Course Description",
                          "long_description": "Courses on Sokratik have an About page that includes a course video, description, and more. Draft the text students will read before deciding to enroll in your course.",
                          "is_checked": False,
                          "action_url": "SettingsDetails",
